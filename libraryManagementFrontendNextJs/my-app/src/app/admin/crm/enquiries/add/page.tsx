...
import { addEnquirySchema, type AddEnquiryFormData } from '@/app/admin/crm/reusable/schema';
import data from '@/app/admin/crm/reusable/hardcoded.json';
...
export default function AddEnquiryPage() {
  ...
  const onSubmit = async (formData: AddEnquiryFormData) => {
    ...
    setTimeout(() => router.push('/admin/crm/enquiries'), 600);
  };

  const handleClose = () => router.push('/admin/crm/enquiries');
