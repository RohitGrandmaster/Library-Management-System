    ...
    <div className="mgr-page">
      <div className="mgr-page-header">
        ...
        <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
          ...
          <Link href="/students/group" className="mgr-btn-ghost mgr-btn-sm"><Users2 size={14} /> Group Admission</Link>
          <Link href="/students/new" className="mgr-btn-primary"><UserPlus size={14} /> New Admission</Link>
        </div>
      </div>
