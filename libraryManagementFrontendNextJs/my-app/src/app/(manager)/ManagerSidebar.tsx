...
const NAV: NavItem[] = [
  ...
  { href: '/students/group',      icon: Users2,     label: 'Group Admission'  },
  { href: '/students/alumni',     icon: UserCheck,  label: 'Alumni'           },
  { href: '/documents',           icon: FolderOpen, label: 'Document Vault'   },
  { href: '/students/referrals',  icon: Award,      label: 'Referral Bonus'   },
  { href: '/students/id-card',    icon: CreditCard, label: 'ID Card Generator'},
  { group: 'Seats & Shifts' },
