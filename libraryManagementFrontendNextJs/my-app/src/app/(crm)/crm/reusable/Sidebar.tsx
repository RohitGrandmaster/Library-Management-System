...
const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      { href: '/expenses',           Icon: BadgeDollarSign, label: 'Expenses'           },
      { href: '/financial-reports',  Icon: TrendingUp,      label: 'Financial Reports'  },
      { href: '/daily-settlement',   Icon: Activity,        label: 'Daily Settlement'   },
      { href: '/seat-gap-report',    Icon: Sofa,            label: 'Seat Gap Report'    },
      { href: '/shift-gap-analyzer', Icon: ArrowLeftRight,  label: 'Shift Gap Analyzer' },
      { href: '/assets',             Icon: PackageSearch,   label: 'Assets'             },
      { href: '/asset-maintenance',  Icon: Wrench,          label: 'Asset Maintenance'  },
    ],
  },
  {
    group: 'Communication',
