...
import { addEnquirySchema, type AddEnquiryFormData } from '@/app/(crm)/crm/reusable/schema';
...
export default function AddEnquiryPage() {
  ...
  const onSubmit = async (formData: AddEnquiryFormData) => {
    ...
    setTimeout(() => router.push('/crm/enquiries'), 600);
  };

  const handleClose = () => router.push('/crm/enquiries');
