  ...
  return (
    <div className="space-y-6">
      ...
      <div className="fin-filter-bar flex items-center justify-between p-4 bg-[var(--mgr-bg-card)] border border-[var(--mgr-border)] rounded-lg">
        ...
        <button className="fin-badge fin-badge--neutral cursor-pointer hover:border-[var(--mgr-primary)] flex items-center gap-1" onClick={() => router.push('/accounting/expenses/add')}>
