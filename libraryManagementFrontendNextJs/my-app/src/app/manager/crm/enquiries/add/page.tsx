...
import { addEnquirySchema, type AddEnquiryFormData } from '@/app/manager/crm/reusable/schema';
import data from '@/app/manager/crm/reusable/hardcoded.json';
...
export default function AddEnquiryPage() {
  ...
  const onSubmit = async (formData: AddEnquiryFormData) => {
    ...
    setTimeout(() => router.push('/manager/crm/enquiries'), 600);
  };

  const handleClose = () => router.push('/manager/crm/enquiries');
