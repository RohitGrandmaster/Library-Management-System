    ...
    <div>
      ...
      <div className="mgr-page-header">
        ...
        <div className="mgr-page-actions">
          <Link href="/manager/reports" className="mgr-btn-ghost mgr-btn-sm">
            ...
            <div className="mgr-seat-grid">
              {data.seatData?.map((seat: any) => (
                <div
                  ...
                  onClick={() => router.push(`/manager/students?seat=${seat.id}`)}
                >
                  {seat.id}
                </div>
              ))}
      ...
      <div className="mgr-dashboard-row3 mgr-section-gap">
        ...
        <div className="mgr-card">
          <div className="mgr-card-header">
            ...
            <Link href="/manager/students" className="mgr-action-link">View all</Link>
          </div>
