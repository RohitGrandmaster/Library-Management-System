...
const NAV: NavItem[] = [
  ...
  { href: '/daily-settlement',  icon: Receipt,    label: 'Daily Settlement'  },
  { href: '/seat-gap-report',   icon: LayoutGrid, label: 'Seat Gap Report'   },
  { href: '/assets',            icon: BarChart,   label: 'Assets'            },
  { href: '/asset-maintenance', icon: BarChart,   label: 'Asset Maintenance' },
  { group: 'Communication' },
