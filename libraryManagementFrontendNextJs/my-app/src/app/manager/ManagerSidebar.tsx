...
const NAV: NavItem[] = [
  ...
  { href: '/manager/reports',   icon: BarChart2,       label: 'Reports'   },
  { group: 'CRM' },
  { href: '/crm/enquiries',       icon: Phone,      label: 'Enquiries'        },
  { group: 'Students' },
  { href: '/manager/students',            icon: Users,      label: 'All Students'     },
  { href: '/manager/students/new',        icon: UserPlus,   label: 'New Admission'    },
  { href: '/manager/students/group',      icon: Users2,     label: 'Group Admission'  },
  { href: '/manager/students/alumni',     icon: UserCheck,  label: 'Alumni'           },
  { href: '/manager/documents',           icon: FolderOpen, label: 'Document Vault'   },
  { href: '/manager/students/referrals',  icon: Award,      label: 'Referral Bonus'   },
  { href: '/manager/students/id-card',    icon: CreditCard, label: 'ID Card Generator'},
  { group: 'Seats & Shifts' },
  { href: '/seats_shifts_lockers/seat-matrix',      icon: LayoutGrid,     label: 'Seat Matrix'     },
  { href: '/seats_shifts_lockers/seat-management',  icon: Armchair,       label: 'Seats'           },
  { href: '/seats_shifts_lockers/shift-management', icon: RefreshCw,      label: 'Shifts'          },
  { href: '/seats_shifts_lockers/shift-migration',  icon: ArrowLeftRight, label: 'Shift Migration' },
  { href: '/seats_shifts_lockers/allocations',      icon: ClipboardList,  label: 'Allocations'     },
  { href: '/seats_shifts_lockers/seat-history',     icon: History,        label: 'Seat History'    },
  { href: '/seats_shifts_lockers/lockers',          icon: Lock,           label: 'Lockers'         },
  { href: '/seats_shifts_lockers/locker-matrix',    icon: LayoutGrid,     label: 'Locker Matrix'   },
  { group: 'Finance' },
  { href: '/finance/collect-fee',       icon: IndianRupee, label: 'Collect Fee'       },
  { href: '/finance/subscriptions',     icon: FileText,    label: 'Subscriptions'     },
  { href: '/finance/renewals',          icon: RotateCcw,   label: 'Renewals'          },
  { href: '/finance/payments',          icon: CreditCard,  label: 'Payments'          },
  { href: '/finance/payment-promises',  icon: Handshake,   label: 'Payment Promises'  },
  { href: '/finance/trust-score',       icon: Shield,      label: 'Trust Scores'      },
  { href: '/finance/security-deposits', icon: Wallet,      label: 'Security Deposits' },
  { href: '/finance/late-fees',         icon: Clock,       label: 'Late Fees'         },
  { href: '/finance/auto-suspend',      icon: Ban,         label: 'Auto-Suspend'      },
  { href: '/finance/invoice',           icon: Receipt,     label: 'Invoice'           },
  { href: '/finance/receipt',           icon: BookOpen,    label: 'Receipt'           },
  { href: '/finance/referrals',         icon: Award,       label: 'Referrals'         },
  { href: '/finance/refunds',           icon: DollarSign,  label: 'Refunds'           },
  { group: 'Operations' },
  { href: '/engagement/attendance',       icon: CalendarCheck,  label: 'Attendance'       },
  { href: '/engagement/absentee-report',  icon: ClipboardCheck, label: 'Absentee Report'  },
  { href: '/engagement/qr-scanner',       icon: QrCode,         label: 'QR Scanner'       },
  { href: '/engagement/holiday-calendar', icon: Calendar,       label: 'Holiday Calendar' },
  { group: 'Accounts & Assets' },
  { href: '/accounting/expenses',          icon: TrendingUp, label: 'Expenses'          },
  { href: '/accounting/daily-settlement',  icon: Receipt,    label: 'Daily Settlement'  },
  { href: '/accounting/seat-gap-report',   icon: LayoutGrid, label: 'Seat Gap Report'   },
  { href: '/accounting/assets',            icon: BarChart,   label: 'Assets'            },
  { href: '/accounting/asset-maintenance', icon: BarChart,   label: 'Asset Maintenance' },
  { group: 'Communication' },
  { href: '/communication/notices',             icon: Bell,          label: 'Notices'             },
  { href: '/communication/complaints',          icon: MessageSquare, label: 'Complaints'          },
  { href: '/communication/notification-center', icon: BellRing,      label: 'Notification Center' },
  { href: '/communication/whatsapp-logs',       icon: Smartphone,    label: 'WhatsApp Logs'       },
  { href: '/communication/whatsapp-templates',  icon: Smartphone,    label: 'WhatsApp Templates'  },
];
