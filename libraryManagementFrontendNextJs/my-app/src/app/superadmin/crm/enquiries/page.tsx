...
import {
  ...
  STATUS_BADGE,
  maskPhone,
} from '@/app/superadmin/crm/reusable/types';
        ...
        <div className="crm-page-header-row">
          ...
          <div className="crm-page-header-actions">
            ...
            <button
              ...
              onClick={() => router.push('/superadmin/crm/enquiries/add')}
            >
              <Plus size={16} />
              Add Enquiry
            </button>
                      ...
                      {cards.length === 0 ? (
                        ...
                        cards.map((enq) => (
                          <KanbanCard
                            ...
                            onClick={() => router.push(`/superadmin/crm/enquiries/${enq.id}`)}
                          />
                        ))
                      )}
                    </div>
                      ...
                      <td>
                        <div className="crm-row-actions">
                          <button
                            ...
                            onClick={(e) => {
                              e.stopPropagation();
                              router.push(`/superadmin/crm/enquiries/${enq.id}`);
                            }}
                          >
                            <Eye size={14} />
                          </button>
