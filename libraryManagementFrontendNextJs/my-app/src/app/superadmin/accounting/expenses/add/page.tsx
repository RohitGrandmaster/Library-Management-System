...
export default function AddExpensePage() {
  ...
  const handleSave = () => {
    ...
    setTimeout(() => {
      ...
      router.push('/superadmin/accounting/expenses');
    }, 700);
  };
  ...
  return (
    <div className="space-y-6 max-w-xl">
      ...
      <div className="flex gap-3">
        <button className="fin-badge fin-badge--neutral cursor-pointer" onClick={() => router.push('/superadmin/accounting/expenses')}>Cancel</button>
